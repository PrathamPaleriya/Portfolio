...
function App() {
  ...
  return (
    <div className="relative font-youngserif w-full h-full">
      ...
      <div className="relative w-[70%] h-[70%] bg-white rounded-xl flex flex-col items-center p-10 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
              ...
              <div className="relative lg:text-2xl mb-10">
                Past Experince
              </div>
              <div className=" relative lg:w-[600px] lg:px-[76px] lg:py-[78px] bg-[#f3f0ff] rounded-2xl  overflow-hidden">
                <div className="absolute w-[300px] aspect-square bg-[#8567ff]/10 rounded-full -right-7 -bottom-20"></div>
                <div className="flex justify-between items-center w-full">
                  <img src={qlinklogo} alt="logo" className="" />
                  <div>Oct 2024 - Present</div>
                </div>
  
                <div className="lg:text-3xl text-start my-10">
                  AI Software Engineer
                </div>
  
                <div className="text-sm bg-white w-fit px-3 py-2 rounded-full">
                  Intern
                </div>
              </div>
            </div>
      ...
      {/* hero section */}
      <div className="relative w-full h-screen z-10 flex flex-col justify-center items-center text-white lg:text-6xl">
        <div className="w-[30%] text-center leading-snug">
          <BlurIn>
      ...
      <div className="lg:px-20">
        {/* intro section */}
        <TextFade className="w-full h-full flex flex-col justify-center items-center lg:gap-14 lg:mt-40 lg:mb-44 text-cente px-32">
          <div className="lg:text-4xl text-ppurple">Hello 👋🏻</div>
          <div className="lg:text-6xl text-center w-full leading-snug">
            I&#39;m Software Developer,<br/> who Built things for web
          </div>
          <div className="lg:text-2xl text-center text-pgray leading-snug w-full">
        ...
        {/* teachnologies */}
        <div className="lg:my-44 text-center space-y-20">
          <div className="lg:text-4xl"><div>Technologies I've expertise in</div></div>

          <div className="space-y-10">
            <TextFade className="w-full flex justify-center items-center gap-10">
        ...
        {/* Projects */}
        <div className="lg:my-44 text-center space-y-40">
          <TextFade className="flex flex-col items-center lg:gap-5 z-10">
            <div className="lg:text-2xl font-serif">Projects</div>
            <div className="lg:text-4xl">Solutions that I&#39;ve build</div>
          </TextFade>
        ...
        {/* Experince */}
        <div className="lg:my-44 w-full text-center space-y-20 flex-col">
          <TextFade className="flex flex-col items-center lg:gap-5 z-10">
            <div className="lg:text-2xl font-serif">Experience</div>
          ...
          <div className="flex flex-col justify-center items-center gap-8">
            ...
            <button onClick={handleShowModal} className="text-2xl cursor-pointer underline text-pgray font-serif">
              view pervious
            </button>
          </div>
        </div>
        ...
        {/* Contact form */}
        <div className="flex w-full justify-between items-center lg:my-24">
          <TextFade className="w-[50%] flex flex-col justify-center gap-14 h-full">
